    ...
    return (
      <div className="flex flex-col items-center gap-6 py-10 text-center">
        ...
        <div className="flex flex-col gap-2">
          <h3 className="text-2xl font-black" style={{ color: "#1A2E25" }}>קיבלנו.</h3>
          <p className="leading-relaxed max-w-sm" style={{ color: "#7A9E8E" }}>
        ...
        >
          <p className="text-sm mb-3" style={{ color: "#7A9E8E" }}>מה הצפוי:</p>
          <p className="font-medium" style={{ color: "#1A2E25" }}>📞 שיחת היכרות קצרה - 20 דקות</p>
          <p className="text-sm mt-1" style={{ color: "#7A9E8E" }}>בלי מצגת מכירה. רק שיחה כנה על העסק שלך.</p>
